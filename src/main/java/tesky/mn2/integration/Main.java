...
public class Main {
    public static void main(String[] args) {
        ...
        switch (functionIndex) {
            case 0: function = new Sin(); break;
            case 1: function = new Sin2(); break;
            case 2: function = new Cos2(); break;
            default: throw new RuntimeException("Função inválida!");
        }
        ...
        if (IntegrationPhilosophy.isOpened(integrationPhilosophy.toLowerCase(Locale.ROOT))) {
            ...
            switch (N) {
                ...
                case 4:
                    ...
                    break;
                default: throw new RuntimeException("Grau inválido!");
            }
            ...
            switch (N) {
                ...
                case 4:
                    ...
                    break;
                default: System.err.println("Grau inválido!");
            }
        } else {
